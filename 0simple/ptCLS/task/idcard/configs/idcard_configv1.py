...
class modelconfig(configbase.configBase):
    ...
    def _makemodconfig(self):
        ...
        生成模型配置文件
        """
        self.modcfg.train_type = "idcard_truefalse"
        ...
        # self.modcfg.netname = "convnext_tiny_in22k"
    ...
    def _makedataconfig(self):
        ...
        if platformname == 'windows':
            predir = "E:/WorkSpace/AIbase/pytorchCLS/dataset/idcard/train/"
        else:  # linux
            predir = "/home/dataset/idcard/train/"
        ...
        # 测试数据
        if platformname == 'windows':
            predir = "E:/WorkSpace/AIbase/pytorchCLS/dataset/idcard/valid/"
        else:  # linux
            predir = "/home/dataset/idcard/valid/"
        ...
        self.datacfg.bboxextsize = 1.0  # bbox扩张系数
