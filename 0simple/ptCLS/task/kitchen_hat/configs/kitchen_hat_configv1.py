...
class modelconfig(configbase.configBase):
    ...
    def _makedataconfig(self):
        ...
        # 标签类型与对应目录配置
        self.datacfg.label_map = {"nohat": 0, "hat": 1, "uncertain": 2}
        # 是否重新生成标签文本
        ...
        torchtransseq = transforms.Compose([
            configbase.RandomCrop(0.1, 2.0, new_expansion_rate=0.15, to_bgr=False),  # set to_bgr=False
