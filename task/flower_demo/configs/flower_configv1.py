...
class modelconfig(configbase.configBase):
    ...
    def _makemodconfig(self):
        ...
        生成模型配置文件
        """
        self.modcfg.train_type = "flower_demo"
    ...
    def _makedataconfig(self):
        ...
        if platformname == 'windows':
            predir = "D:/AIbase/pytorchCLS/dataset/flower_data/train/"
        else:  # linux
            predir = "/home/dataset/flower_data/train/"
        ...
        # 测试数据
        if platformname == 'windows':
            predir = "D:/AIbase/pytorchCLS/dataset/flower_data/valid/"
        else:  # linux
            predir = "/home/dataset/flower_data/valid/"
        self.datacfg.valdata = [
            predir + "data/"
        ]

        # 标签类型与对应目录配置
        self.datacfg.label_map = {"flower1": 0, "flower1 (2)": 1, "flower1 (3)": 2, "flower1 (4)": 3}
        # 是否重新生成标签文本
